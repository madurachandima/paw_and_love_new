...
class NewSell extends StatelessWidget {
        ...
        children: [
          Padding(
            ...
            child: CustomeTextInputField(
                isReadOnly: false,
                textEditingController: _controller.itemNameController.value,
                isPass: false,
                hintText: "Item Name",
                lableText: "",
          ...
          Padding(
            ...
            child: CustomeTextInputField(
                ...
                isReadOnly: false,
                textEditingController: _controller.descriptionController.value,
                isPass: false,
              ...
              child: Theme(
                ...
                child: DropdownSearch(
                  ...
                  dropdownSearchBaseStyle:
                      TextStyle(color: ColorConfig.orange, fontSize: 13.sp),
                  onChanged: (value) =>
          ...
          Padding(
            ...
            child: CustomeTextInputField(
                isMultyLineText: true,
                isReadOnly: false,
                textEditingController: _controller.shopAddressController.value,
                isPass: false,
                hintText: "Address",
                lableText: "",
                textInputType: TextInputType.name,
                  ...
                  children: _controller.keywords
                      .map((element) => Padding(
                            ...
                            child: Chip(
                              ...
                              onDeleted: () {
                                _controller.keywords.removeAt(
                                    _controller.keywords.indexOf(element));
                              },
                            ),
                          ))
                      .toList(),
          ...
          Padding(
            padding:
                const EdgeInsets.only(left: 20, right: 20, top: 20, bottom: 10),
            child: CustomeTextInputField(
                isEnableInputAction: true,
                onSubmitCallbackFunction: (value) {
                  _controller.keywords.add(value);
                  _controller.keywordsController.value.clear();
                },
                isMultyLineText: false,
                isReadOnly: false,
                textEditingController: _controller.keywordsController.value,
                isPass: false,
          ...
          Padding(
            padding:
                const EdgeInsets.only(left: 20, right: 30, top: 20, bottom: 10),
            child: Row(children: [
